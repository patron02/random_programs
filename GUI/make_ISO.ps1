<# Synopsis: Creates a new .iso file
  ...
  Authors: Chris Wu, Nicholas Johnson, Laura Patron #> 
...
$source_dir = "C:\Users\USLARAM1\OneDrive - ABB\Desktop\source"
get-childitem "$source_dir" | New-ISOFile -path "c:\temp\file.iso"